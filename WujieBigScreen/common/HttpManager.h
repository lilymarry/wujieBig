 ...
 *  @param failure failure
 */
+ (void)postUploadSingleImageWithUrl:(NSString *)url   baseurl:(NSString *)baseurl andImageName:(UIImage *)image andKeyName:(NSString *)keyName andParameters:(NSDictionary *)params andSuccess:(HttpSuccessBlock)success andFail:(HttpFailureBlock)failure;
 ...
 *  @param failure failure
 */
+ (void)postUploadMultipleImagesWithUrl:(NSString *)url baseurl:(NSString *)baseurl andImageNames:(NSArray *)images andKeyName:(NSString *)keyName andParameters:(NSDictionary *)params andSuccess:(HttpSuccessBlock)success andFail:(HttpFailureBlock)failure;
 ...
 *  @param failure       failure
 */
+ (void)postUploadMultipleImagesWithUrl:(NSString *)url baseurl:(NSString *)baseurl andImagesAndNames:(NSDictionary *)imageAndNames andParameters:(NSDictionary *)params andSuccess:(HttpSuccessBlock)success andFail:(HttpFailureBlock)failure;
